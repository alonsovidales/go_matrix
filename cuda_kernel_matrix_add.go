...
)
{
	...
	ld.param.u64 	%rd4, [matrixAdd_param_0];
	ld.param.u64 	%rd5, [matrixAdd_param_1];
	ld.param.u64 	%rd6, [matrixAdd_param_2];
	ld.param.u32 	%r9, [matrixAdd_param_3];
	ld.param.u32 	%r10, [matrixAdd_param_4];
	ld.param.u32 	%r11, [matrixAdd_param_5];
	ld.param.u32 	%r12, [matrixAdd_param_6];
	ld.param.u32 	%r13, [matrixAdd_param_7];
