...
.visible .entry matrixPowTwo(
	...
	.param .u32 matrixPowTwo_param_5
)
{
	.reg .pred 	%p<7>;
	.reg .s32 	%r<20>;
	...
	ld.param.u64 	%rd2, [matrixPowTwo_param_0];
	ld.param.u32 	%r9, [matrixPowTwo_param_1];
	ld.param.u32 	%r10, [matrixPowTwo_param_2];
	ld.param.u32 	%r11, [matrixPowTwo_param_3];
	ld.param.u32 	%r12, [matrixPowTwo_param_4];
	ld.param.u32 	%r13, [matrixPowTwo_param_5];
