...
BB0_11:
	{
	.reg .b32 %temp; 
	mov.b64 	{%temp, %r14}, %fd21;
	}
	xor.b32  	%r15, %r14, -2147483648;
	{
	.reg .b32 %temp; 
	mov.b64 	{%r16, %temp}, %fd21;
	}
	mov.b64 	%fd21, {%r16, %r15};
	bra.uni 	BB0_15;
