...
.visible .entry matrixSigmoidGrad(
	...
	.param .u32 matrixSigmoidGrad_param_5
)
{
	.reg .pred 	%p<22>;
	.reg .s32 	%r<35>;
	...
	ld.param.u32 	%r9, [matrixSigmoidGrad_param_1];
	ld.param.u32 	%r10, [matrixSigmoidGrad_param_2];
	ld.param.u32 	%r11, [matrixSigmoidGrad_param_3];
	ld.param.u32 	%r12, [matrixSigmoidGrad_param_4];
	ld.param.u32 	%r13, [matrixSigmoidGrad_param_5];
...
BB0_2:
	mov.u32 	%r16, %tid.x;
	mad.lo.s32 	%r2, %r34, %r9, %r16;
	mov.u32 	%r33, %r14;

BB0_3:
	mov.u32 	%r3, %r33;
	mov.u32 	%r17, %tid.y;
	mad.lo.s32 	%r18, %r3, %r10, %r17;
	mad.lo.s32 	%r4, %r18, %r11, %r2;
	setp.lt.s32	%p2, %r4, %r12;
	setp.lt.s32	%p3, %r2, %r11;
	and.pred  	%p4, %p2, %p3;
	@!%p4 bra 	BB0_19;
	bra.uni 	BB0_4;
...
BB0_4:
	...
	{
	.reg .b32 %temp; 
	mov.b64 	{%temp, %r5}, %fd11;
	}
	{
	.reg .b32 %temp; 
	mov.b64 	{%temp, %r6}, %fd1;
	}
	mul.f64 	%fd12, %fd1, 0d3FE0000000000000;
	cvt.rzi.f64.f64	%fd13, %fd12;
	fma.rn.f64 	%fd14, %fd13, 0dC000000000000000, %fd1;
	abs.f64 	%fd2, %fd14;
...
BB0_15:
	...
	selp.b32	%r27, %r26, %r25, %p17;
	mov.b64 	%fd21, {%r22, %r27};
	bra.uni 	BB0_18;

BB0_16:
	setp.gt.f64	%p18, %fd3, 0d3FF0000000000000;
	selp.b32	%r28, 2146435072, 0, %p18;
	mov.u32 	%r29, 0;
	xor.b32  	%r30, %r28, 2146435072;
	setp.lt.s32	%p19, %r6, 0;
	selp.b32	%r31, %r30, %r28, %p19;
	mov.b64 	%fd21, {%r29, %r31};
	bra.uni 	BB0_18;

BB0_17:
	add.f64 	%fd21, %fd1, 0d4005BF0A8B145769;

BB0_18:
	add.f64 	%fd19, %fd21, 0d3FF0000000000000;
...
BB0_19:
	add.s32 	%r7, %r3, 1;
	setp.lt.s32	%p20, %r7, %r13;
	mov.u32 	%r33, %r7;
	@%p20 bra 	BB0_3;

	add.s32 	%r34, %r34, 1;
	setp.lt.s32	%p21, %r34, %r13;
	@%p21 bra 	BB0_2;
